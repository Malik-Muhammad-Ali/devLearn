        ...
        >
          ...
          >
            ...
            <span className="relative inline-block mt-2">
              <span className="relative z-10 text-indigo-600">AI-Powered Learning</span>
              <motion.div
                initial={{ width: 0 }}
          ...
          >
            Experience a revolutionary approach to learning with our advanced AI platform. Get personalized guidance, real-time feedback, and track your progress like never before.
          </motion.p>
        </motion.div>
              ...
              <div className="h-full bg-white rounded-2xl shadow-lg p-8 transition-all duration-200">
                ...
                <div className="pt-6 border-t border-gray-100">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-lg font-bold text-indigo-600">{feature.stats}</span>
                  </div>
                  <motion.div
                    initial={{ width: 0 }}
                    whileInView={{ width: "100%" }}
