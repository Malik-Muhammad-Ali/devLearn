      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            cutting-edge features designed to maximize your potential.
          </motion.p>
        </motion.div>
          ...
          {features.map((feature, idx) => (
            ...
            >
              <div className="h-full bg-white rounded-2xl shadow-lg p-8 transition-all duration-200">
                <div
                  className={`w-14 h-14 ${feature.color} rounded-xl flex items-center justify-center text-white mb-6`}
                >
                  {feature.icon}
                </div>
