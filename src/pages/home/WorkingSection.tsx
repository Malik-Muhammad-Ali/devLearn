  ...
  const steps = [
    {
      ...
      description:
        "The AI generates a customized quiz based on your preferences or chosen topic. It curates questions, options, and difficulty levels tailored to your learning goals.",
      icon: (
        <svg
          className="w-10 h-10"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Solve the quiz by selecting answers to multiple-choice or other question types. The platform tracks your time and answers to assess your performance in real-time.",
      icon: (
        <svg
          className="w-10 h-10"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Receive a detailed performance report with your score and insights. Get personalized recommendations for resources like articles, tutorials, or courses to improve your skills.",
      icon: (
        <svg
          className="w-10 h-10"
          fill="none"
    ...
    <section className="relative py-24 overflow-hidden bg-gradient-to-b from-slate-950 to-slate-900">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Our AI-powered platform makes learning efficient and personalized
            ...
            {steps.map((step, idx) => (
              ...
              >
                <div className="relative z-10 transition-transform duration-300 hover:-translate-y-2 h-full">
                  {/* Card */}
                  <div
                    className={`h-full rounded-3xl ${step.bgGradient} backdrop-blur-xl p-8 border border-white/5 transition-all duration-300 overflow-hidden flex flex-col`}
                  ...
                  >
                    ...
                    <div className="relative mb-8 inline-flex">
                      <div
                        className={`w-20 h-20 bg-gradient-to-r ${step.color} rounded-2xl flex items-center justify-center text-white shadow-lg`}
                        style={{
                          boxShadow: `0 10px 30px -5px ${step.accent}40`,
                        }}
                      >
                        {step.icon}
                      </div>
                    ...
                    <div
                      className={`absolute bottom-0 left-0 h-1 w-full bg-gradient-to-r ${step.color} rounded-b-3xl opacity-70 group-hover:opacity-100 transition-opacity duration-300`}
                    />
                  </div>
                </div>
                ...
                {/* Shadow */}
                <div
                  className={`absolute -bottom-4 left-4 right-4 h-10 bg-gradient-to-r ${step.color} opacity-20 blur-xl rounded-full transform scale-x-[0.85] group-hover:scale-x-95 transition-transform duration-300`}
                />
              </motion.div>
            ))}
          </motion.div>
        ...
        >
          <Link to="/signin">
            <motion.button
              variants={itemVariants}
              className="relative inline-flex items-center px-10 py-5 text-lg font-bold text-white bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full shadow-lg shadow-cyan-500/25 hover:shadow-cyan-500/40 transition-all duration-300 overflow-hidden group hover:scale-105 cursor-pointer"
            >
