        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="text-center">
            <h4 className="text-xl font-medium text-gray-900">
              Our Growth, Defined by Achievements
            </h4>
          </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1.5 text-lg font-medium leading-tight text-gray-500">
                      Years of Revolutionizing Learning
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="overflow-hidden bg-white border border-gray-200 rounded-lg">
              <div className="px-4 py-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="text-4xl font-bold text-gray-900">4600+</h4>
                    <p className="mt-1.5 text-lg font-medium leading-tight text-gray-500">
                      Engaged Learners
                    </p>
                  </div>
              ...
              <div className="px-4 py-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1.5 text-lg font-medium leading-tight text-gray-500">
                      Success Rate in Skill Development
                    </p>
                  </div>
                </div>
              </div>
